    ...
    return <div className="absolute h-screen w-screen">
        ...
        <motion.div initial={{ left: -100 }} animate={{ left: 0 }} className="h-screen w-[70vw] text-white bg-[#111] flex-col flex p-5 fixed z-50 text-2xl">
            <div className={"py-5 pl-5 mt-10 flex flex-col"}>
                ...
                <Link to="/aboutUs" className={"border-b-[1px] active:text-orange focus:text-orange border-white p-3"}
                    onClick={() => setOpenBar(false)}>О нас</Link>
                <Link to="/News" className={"border-b-[1px] active:text-orange focus:text-orange border-white p-3"}
                    onClick={() => setOpenBar(false)}>Новости</Link>
                ...
                <Link to="/ways" className={"border-b-[1px] active:text-orange focus:text-orange border-white p-3"}
                    onClick={() => setOpenBar(false)}>Направления</Link>
            </div>
        </motion.div>
    </div>
